...
const fizdatum Tanh::eval(fizstack &stack, const FizObject &obj1, const triangle &tri1, const FizObject &obj2, const triangle &tri2)
{
	fizdatum c;
	c.type = SCALAR;
	if (numOperands == 1)
...
const std::string Tanh::toString(fizstack& stack)
{
	std::string val = "";
