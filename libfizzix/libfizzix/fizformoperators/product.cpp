...
const fizdatum Product::eval(fizstack &stack, const FizObject &obj1, const triangle &tri1, const FizObject &obj2, const triangle &tri2)
{
	fizdatum product=stack.pop()->eval(stack, obj1, tri1, obj2, tri2);
	fizdatum next;
